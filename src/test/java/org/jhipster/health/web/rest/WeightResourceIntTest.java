...
public class WeightResourceIntTest {
    ...
    public void createWeight() throws Exception {
        ...
        assertThat(testWeight.getTime()).isEqualTo(DEFAULT_TIME);
        ...
        assertThat(testWeight.getTime()).isEqualTo(testWeight.getTime());
        assertThat(weightEs).isEqualToIgnoringGivenFields(testWeight, "time");
    }
    ...
    public void updateWeight() throws Exception {
        ...
        Weight testWeight = weightList.get(weightList.size() - 1);
        assertThat(testWeight.getTime()).isEqualTo(UPDATED_TIME);
