...
import org.jhipster.health.TweentyOnePointsApp;
...
@SpringBootTest(classes = TweentyOnePointsApp.class)
public class BloodPressureResourceIntTest {
    ...
    public void createBloodPressure() throws Exception {
        ...
        assertThat(testBloodPressure.getTime()).isEqualTo(DEFAULT_TIME);
        ...
        assertThat(testBloodPressure.getTime()).isEqualTo(testBloodPressure.getTime());
        assertThat(bloodPressureEs).isEqualToIgnoringGivenFields(testBloodPressure, "time");
    }
    ...
    public void updateBloodPressure() throws Exception {
        ...
        BloodPressure testBloodPressure = bloodPressureList.get(bloodPressureList.size() - 1);
        assertThat(testBloodPressure.getTime()).isEqualTo(UPDATED_TIME);
